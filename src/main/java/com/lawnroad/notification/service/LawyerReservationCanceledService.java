...
import com.lawnroad.notification.dto.LawyerReservationCanceledDto;
...
public class LawyerReservationCanceledService {
  
  private final SolapiConfig solapiConfig;
  
  public void send(LawyerReservationCanceledDto dto) {
    // Solapi SDK 초기화
    ...
    kakaoOption.setTemplateId("KA01TP250604015902336n392xDQyRXe");
