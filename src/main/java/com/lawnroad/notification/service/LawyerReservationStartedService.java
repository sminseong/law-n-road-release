...
import com.lawnroad.notification.dto.LawyerReservationStartedDto;
...
public class LawyerReservationStartedService {
  
  private final SolapiConfig solapiConfig;
  
  public void send(LawyerReservationStartedDto dto) {
    // Solapi SDK 초기화
    ...
    kakaoOption.setTemplateId("KA01TP25060401534425184vFcxbNkFV");
