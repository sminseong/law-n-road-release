...
import com.lawnroad.notification.dto.ClientReservationStartedDto;
...
public class ClientReservationStartedService {
  
  private final SolapiConfig solapiConfig;
  
  public void send(ClientReservationStartedDto dto) {
    // Solapi SDK 초기화
    ...
    kakaoOption.setTemplateId("KA01TP250604015638507TRX1yd86laY");
