...
import com.lawnroad.notification.dto.VerificationCodeDto;
...
public class VerificationCodeService {
  ...
  public void send(VerificationCodeDto dto) {
    // Solapi SDK 초기화
    ...
    kakaoOption.setTemplateId("KA01TP250604013845278vapcp9mNulh");
    
    Map<String, String> variables = new HashMap<>();
    variables.put("#{code}", dto.getCode());
